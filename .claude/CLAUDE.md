...
- **Remaining UAT**: §6 report-rendering smoke (light), §7.1 Square (blocked on staging secrets), §4.11 Plaid (external). All test docs created during the run were deleted + a final §1 gate confirmed baseline.
